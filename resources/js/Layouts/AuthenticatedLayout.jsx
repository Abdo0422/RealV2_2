                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    <div className="pt-2 pb-3 space-y-1">
                        ...
                        <div className="collapse" id="ui-basic">
                            ...
                            <li className="nav-item"> <ResponsiveNavLink href={route('product.form_add')} active={route().current('product.form_add')}>Add Product</ResponsiveNavLink></li>
                            <li className="nav-item"> <ResponsiveNavLink href={route('products.show')} active={route().current('products.show')}>Show Product</ResponsiveNavLink></li>
                            </ul>
                        </div>
                        </li>
