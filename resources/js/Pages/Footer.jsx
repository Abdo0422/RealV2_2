...
const Footer = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_zvnvh8s', 'template_ypb0cme', form.current, 'lLFU9Ei_1Wwp2lGNn')
      .then(
        (result) => {
  ...
  return (
    <>
      <footer className="footer footer-center p-10 bg-primary text-primary-content flex flex-col items-center justify-center" style={{ marginTop: "40vh" }}>
        <div className="mb-4 w-full flex justify-around">
          <div id='contacter'>
            <form className="contact" ref={form} onSubmit={sendEmail}>
              <h1 className="font-bold text-xl" style={{ marginBottom:'20px' }}>Contactez-nous</h1>
              <div className="flex">
                <div className="mr-10">
          ...
          <div className="flex flex-col items-center" id='realfooter'>
            <Logo />
            <p className="font-bold ">
              <br />Providing E-commerce company since 2023
            </p>
            <p>&copy; {new Date().getFullYear()} - All rights reserved</p>

            <div className="grid grid-flow-col gap-10 mt-6">
              <a>
